...
$soundMessageEnabled = erLhcoreClassModelUserSetting::getSetting('chat_message',(int)($soundData['new_message_sound_user_enabled'])); ?>
	...
	<div class="d-flex flex-row">
			<div class="btn-group dropup pt-1 disable-select">
				<!-- <i class="material-icons settings text-muted 111111" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">settings</i> -->

				<i class="settings fal fa-cog " data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></i>
