...
if (!!window.postMessage) {
    ...
    $(window).on('load',function() {
        ...
        setTimeout(function () {
            ...
            var userD = '<?php echo @$_REQUEST['userD']; ?>';
            var res = userD.split("_");
            
            if (res[0]){
                document.getElementById('username_cust').value = res[0];
                document.getElementById('email_cust').value = res[1];
                document.getElementById('r_cust').value = res[2];
            }
