...
class erLhAbstractModelNewTag {

    use erLhcoreClassDBTrait;

    public static $dbTable = 'lh_tag';
    ...
    public function customForm() {
        return 'newtag.tpl.php';
    }

    public function getFields()
    {
        $items = include ('lib/core/lhabstract/fields/erlhabstractmodelnewtag.php');
        return $items;
    }

    public function getModuleTranslations()
    {
        $metaData = array('permission_delete' => array('module' => 'lhchat','function' => 'administratesubject'),'permission' => array('module' => 'lhchat','function' => 'administratesubject'),'name' => erTranslationClassLhTranslation::getInstance()->getTranslation('abstract/proactivechatinvitation','Tags'));
        /**
