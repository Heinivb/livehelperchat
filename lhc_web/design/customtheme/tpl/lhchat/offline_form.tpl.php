...
<?php else : ?>
	...
	<div class="row">	
			...
			<?php else : ?>
				...
				<?php else : ?>
					<div class="col-12 form-group">
						...
						<input class="form-control form-control-sm<?php if (isset($errors['nick'])) : ?> is-invalid<?php endif;?>" <?php if (isset($start_data_fields['offline_name_require_option']) && $start_data_fields['offline_name_require_option'] == 'required') : ?>aria-required="true" required<?php endif;?> aria-label="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/startchat','Enter your name');?>" placeholder="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/startchat','Enter your name');?>" type="text" id='username_cust' name="Username" value="<?php echo htmlspecialchars($input_data->username);?>" />
					</div>
				<?php endif;?>
		    <?php endif;?>
	    <?php endif;?>
		...
		<?php else : ?>
			...
			<?php else : ?>
				...
				if ( strpos( $_SERVER['HTTP_REFERER'] , "https://www.myaie.ac" ) !== false || strpos( $_SERVER['HTTP_REFERER'] , "portaldev.myway.training" ) !== false )    { ?>


					<div class="col-6 form-group offline_frm">
						...
						<input class="form-control form-control-sm<?php if (isset($errors['email'])) : ?> is-invalid<?php endif;?>" aria-required="true" required aria-label="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/startchat','Enter your email address')?>" placeholder="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/startchat','Enter your email address')?>" type="text" name="Email" id='email_cust' value="<?php echo htmlspecialchars($input_data->email);?>" /> -->

			        <a  target="_blank" href="https://www.myaie.ac/pgs-107-support-ticket.html" title="Tickts" > <i class="fal fa-ticket "></i> Log a Ticket </a>
					
					</div>
					<style>  .leaveamessage { display:none; }  </style>
		...
		<?php else : ?>
			...
			<?php else : ?>
				<div class="form-group">
				   ...
				   <input class="form-control form-control-sm<?php if (isset($errors['phone'])) : ?> is-invalid<?php endif;?>" <?php if (isset($start_data_fields['offline_phone_require_option']) && $start_data_fields['offline_phone_require_option'] == 'required') : ?>aria-required="true" required<?php endif;?> aria-label="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/startchat','Enter your phone')?>" placeholder="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/startchat','Enter your phone')?>" type="text" name="Phone" value="<?php echo htmlspecialchars($input_data->phone);?>" />
				</div>
			<?php endif; ?>
		<?php endif; ?>
	<?php endif; ?>
	...
	<div class="form-group">
	   ...
	   <textarea class="form-control form-control-sm<?php if (isset($errors['question'])) : ?> is-invalid<?php endif;?>" <?php if (isset($start_data_fields['offline_message_require_option']) && $start_data_fields['offline_message_require_option'] == 'required') : ?>aria-required="true" required<?php endif;?> aria-label="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/startchat','Enter your message');?>" placeholder="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/startchat','Enter your message');?>" name="Question"><?php echo htmlspecialchars($input_data->question);?></textarea>
	</div>
	<?php endif; ?>
	<?php endif; ?>
