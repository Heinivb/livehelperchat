   ...
   JSON : {
	...
	min : function(initial) {
        ...
        this.removeClass(dm, '<?php echo $chatCSSPrefix?>-has-unread-message');
         ...
         if(this.hasClass(document.getElementById('<?php echo $chatCSSPrefix?>_status_online_container'),'show-online-status')) {
                 this.removeClass(document.getElementById('<?php echo $chatCSSPrefix?>_status_online_container'),'show-online-status');
         this.addClass(document.getElementById('<?php echo $chatCSSPrefix?>_status_online_container'),'hide-online-status');
        }else {
                 this.removeClass(document.getElementById('<?php echo $chatCSSPrefix?>_status_online_container'),'hide-online-status');
         this.addClass(document.getElementById('<?php echo $chatCSSPrefix?>_status_online_container'),'show-online-status');
        }
