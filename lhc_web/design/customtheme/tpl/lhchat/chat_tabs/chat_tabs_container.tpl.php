<div role="tabpanel">
	<ul class="nav nav-pills" role="tablist" id="chat-tab-items-<?php echo $chat->id?>">
	    ...
	    foreach ($chatTabsOrder as $tabItem) : ?>
	       ...
	       <?php  if ($tabItem == 'user_custom_tab') : ?>
	       	 
	       <?php include(erLhcoreClassDesign::designtpl('lhchat/chat_tabs/user_custom_tab.tpl.php')); ?>
	       
	       <?php elseif ($tabItem == 'information_tab_tab') : ?>
	...
	<div class="tab-content">
	   <?php include(erLhcoreClassDesign::designtpl('lhchat/chat_tabs/custom_user_tab.tpl.php')); ?>	
