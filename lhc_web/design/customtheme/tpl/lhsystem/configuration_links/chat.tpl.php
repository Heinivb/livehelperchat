<li>
    ...
    <ul>
        ...
        <!-- <?php if ($currentUser->hasAccessTo('lhtab','list')) : ?>
        <li><a href="<?php echo erLhcoreClassDesign::baseurl('abstract/list')?>/NewTag"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/configuration','Tags');?></a></li>
        <?php endif; ?> -->
