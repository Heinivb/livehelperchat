  ...
  <script type="text/javascript">
        ...
        if (ishold=='1') { 
            ...
            setTimeout (function(){
              ...
              //document.getElementById("id_DepartamentID").value = "5";
              
              var textToFind = 'Finance';

              var dd = document.getElementById('id_DepartamentID');
          ...
          for (i = length-1; i >= 0; i--) {
           ...
           $.ajax(settings).done(function (response) {
                  ...
                  if (ishold=='1') { 
                      ...
                      setTimeout (function(){
                         document.getElementById("category").value = "Portal on Hold";
                         myCat();                       
                      },1)
