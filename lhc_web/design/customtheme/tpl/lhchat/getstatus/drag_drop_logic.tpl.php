domContainer.onmousedown = function(e) {domContainer.setAttribute('draggable','false');};
...
this.addEvent(domContainer, 'dragstart', function (event) {
        ...
        lhc_obj.removeClass(document.getElementById('<?php echo $chatCSSPrefix?>_iframe'),'lhc-loading');
});
